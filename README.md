...
- [`skill-stats`](extensions/skill-stats/README.md) — Publishes `SKILLS: n/m` for unique `SKILL.md` files successfully read in the current session. Depends on `status-bar`.
