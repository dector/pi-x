...
| [`pi-ui`](extensions/pi-ui/README.md) | UI tweaks: configurable working indicator, input-expected bell, `Ctrl+,` action dialog, and `Alt+O` to toggle the newest collapsible transcript entry. | |
